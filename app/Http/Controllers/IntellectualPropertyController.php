...
class IntellectualPropertyController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('intellectual_properties.edit', compact('intellectual_property'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('intellectual_property')->with('flash_message', 'intellectual_property updated!');
    }
